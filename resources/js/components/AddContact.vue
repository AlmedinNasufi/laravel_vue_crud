<template>
  <div>
    <div class="container">
        <h2 class="text-center text-white p-2 bg-primary mt-5">Add Contact</h2>

        <div class="card-body">
            <div class="col-md-6 offset-md-3">
                <form novalidate id="validateForm" @submit.prevent="saveContact" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="contact_no" v-model="contact.contact_no" class="form-control" placeholder="Enter Contact Number">
                    </div>
                    ...
                    <div class="custom-file">
                        ...
                        id="validatedCustomFile" @change="saveImage">
                        <label class="custiom-file-label" 
                        for="validatedCustomFile">Chose file...</label>
                    </div>
